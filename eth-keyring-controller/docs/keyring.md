...
One of the goals of this class is to allow developers to easily add new signing strategies to OneKey. We call these signing strategies Keyrings, because they can manage multiple keys.
